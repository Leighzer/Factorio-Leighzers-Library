...
-- local itemPictures = {
--     { size = 64, filename = "__leighzerlib__/graphics/icons/rainbow-ore.png",   scale = 0.25, mipmap_count = 4 },
--     { size = 64, filename = "__leighzerlib__/graphics/icons/rainbow-ore-1.png", scale = 0.25, mipmap_count = 4 },
--     { size = 64, filename = "__leighzerlib__/graphics/icons/rainbow-ore-2.png", scale = 0.25, mipmap_count = 4 },
--     { size = 64, filename = "__leighzerlib__/graphics/icons/rainbow-ore-3.png", scale = 0.25, mipmap_count = 4 },
--   }
-- leighzermods.utils.createItem("rainbow-ore","__leighzerlib__/graphics/icons/rainbow-ore.png",64,"raw-resource","a",50,itemPictures, "Rainbow ore")
...
--         type="resource",
--         name="rainbow-ore",
--         icons={{icon="__leighzerlib__/graphics/icons/rainbow-ore.png",icon_size=64}},
--         order="a",
